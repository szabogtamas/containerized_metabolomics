...
mSet <- find_metabo_msea(mSet, keep_mSet=TRUE)
path_msea_stats <- mSet$summary_df
```
...
mSet <- PlotQEA.Overview(mSet, img_path, "bar", "png")
include_graphics(paste(img_path, "dpi72.png", sep=""))
```
...
mSet <- PlotPathSummary(mSet, img_path, "png")
include_graphics(paste(img_path, "dpi72.png", sep=""))
```
...
mSet <- PlotKEGGPath(mSet, "hsa00970", 528, 480, "png", NULL)
include_graphics(paste(img_path, "dpi72.png", sep=""))
```