...
path_ora_stats <- mSet$summary_df
```
...
```{r}
# Sow an alternative built-in report

img_path <- file.path(local_folder, "ORA_net_")
mSet2 <- PlotORA(mSet2, img_path, "net", "png")
include_graphics(paste(img_path, "dpi72.png", sep=""))
```
